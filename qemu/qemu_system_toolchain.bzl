...
QemuSystemToolchainInfo = provider(
    ...
    fields = {
        ...
        "system_data_anchor": "A stable file under share/qemu used to locate the QEMU data directory.",
        "system_data_files": "Depset of QEMU system runtime data files.",
...
def _qemu_system_toolchain_impl(ctx):
    ...
    qemu_system_info = QemuSystemToolchainInfo(
        ...
        system_data_anchor = ctx.file.system_data_anchor,
